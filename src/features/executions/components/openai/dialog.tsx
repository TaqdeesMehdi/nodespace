...
export const OpenAiDialog = ({
  ...
  const { data: credentials, isLoading: isLoadingCredentials } =
    useCredentialByTypes(CredentialType.OPENAI);
  ...
  const watchVariableName = form.watch("variableName") || "OpenAI_Summarizer";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto custom-scroll">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure AI model and prompts for OpenAI.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="OpenAI_Summarizer" {...field} />
                  </FormControl>
                  <FormDescription>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    ...
                    for the simple values for {"{{json variables}}"} to
                    stringify objects.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The prompt to send to AI. Use {"{{variables}}"} for the
