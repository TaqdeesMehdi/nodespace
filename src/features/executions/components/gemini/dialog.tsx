...
export const GeminiDialog = ({
  ...
  const { data: credentials, isLoading: isLoadingCredentials } =
    useCredentialByTypes(CredentialType.GEMINI);
  ...
  const watchVariableName =
    form.watch("variableName") || "Gemini_AI_Summarizer";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto custom-scroll">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure AI model and prompts for Gemini.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Gemini_AI_Summarizer" {...field} />
                  </FormControl>
                  <FormDescription>
